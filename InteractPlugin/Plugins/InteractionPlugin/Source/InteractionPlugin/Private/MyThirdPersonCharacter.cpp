...
//	FollowCamera->bUsePawnControlRotation = false; // Camera does not rotate relative to armnt>(TEXT("Camera"));
//    CameraComponent->SetupAttachment(SpringArmComponent);
//
//    // Creazione del componente di interazione
...
//
//    PlayerInputComponent->BindAxis("Turn", this, &AMyThirdPersonCharacter::AddControllerYawInput);
//    PlayerInputComponent->BindAxis("LookUp", this, &AMyThirdPersonCharacter::AddControllerPitchInput);
//
//    PlayerInputComponent->BindAction("Interact", IE_Pressed, this, &AMyThirdPersonCharacter::Interact);
//	void AMyThirdPersonCharacter::SetupPlayerInputComponent(UInputComponent * PlayerInputComponent)
//	{
...
//
//}
//void AInteractPluginCharacter::Move(const FInputActionValue& Value)
//{
//	// input is a Vector2D
...
//}
//
//void AInteractPluginCharacter::Look(const FInputActionValue& Value)
//{
//	// input is a Vector2D
